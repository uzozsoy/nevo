...
# Adapted from lucidrains/vector-quantize-pytorch by Phil Wang under the MIT License.
...
class VectorQuantize(Module):
    def __init__(
        ...
        codebook_class = EuclideanCodebook if not use_cosine_sim else print("cosine sim codebook is stripped away")
